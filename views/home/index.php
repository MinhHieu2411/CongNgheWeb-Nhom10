...
<div class="container-xl">
	<div class="row">
        ...
        <h3>Chính trị</h3>
          ...
          <?php
          //php
            include APP_ROOT.'/models/Database.php';
            ...
            while($row = $result->fetch_assoc()){
              echo '
                  ...
                  <h5>' . $row["created_at"] . '</h5>
									...
									<a href="?controller=news&action=detail&id=' . $row["id"] . '" class="btn btn-primary">Xem thêm <i class="fa fa-angle-right"></i></a>
								</div>						
							</div>
						</div>
            ';}?>
          ...
          //php
            ...
            while($row = $result->fetch_assoc()){
              echo '
                  ...
                  <h5>' . $row["created_at"] . '</h5>
									<p>'. substr($row["content"], 0, 20) .'</p>
									<a href= "'. APP_ROOT.'/views/news/detail.php?id=' . $row["id"] . '"  method="POST" class="btn btn-primary">Xem thêm <i class="fa fa-angle-right"></i></a>
								</div>						
							</div>
						</div>
            ';}?>
